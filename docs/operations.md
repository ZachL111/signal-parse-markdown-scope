...
`signal-parse-markdown-scope` is centered on parsers work in Ruby. The technical target is: Implement a Ruby parsers project for markdown security rule linting, using safe and unsafe fixtures and remediation hints.
...
The score is deterministic. The current threshold is 163. Risk has a penalty of 4, latency has a penalty of 2, and weight contributes a bonus of 6.
