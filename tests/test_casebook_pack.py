"""Regression checks for the signal-parse-markdown-scope casebook."""
...
from casebook.harness import assert_expected, signal_parse_markdown_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(signal_parse_markdown_scope_summary(), assert_expected())
